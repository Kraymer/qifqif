...
TAGS = {"Bars": ["Art Brut", "Sully"], "Clothes": ["Art Brut Shop"]}
TRANSACTION = {
...
QIF_FILE = os.path.join(
    os.path.realpath(os.path.dirname(__file__)), "rsrc", "transac.qif"
)
CFG_FILE = os.path.join(
    os.path.realpath(os.path.dirname(__file__)), "rsrc", "config.json"
)
