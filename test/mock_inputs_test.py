...
class TestBlackBox(unittest.TestCase):
    ...
    @patch("sys.argv", ["qifqif", "-c", testdata.CFG_FILE, "-a", testdata.QIF_FILE])
    ...
    KEYBOARD_INPUTS = KEYBOARD_BASE + [EOFError]  # Ctrl+D
    ...
    KEYBOARD_INPUTS = KEYBOARD_BASE + [KeyboardInterrupt]  # Ctrl+D
